  ...
  return (
    <main className="flex flex-1 bg-black px-2.5 py-3">
      <section className="flex w-full flex-col gap-2.5">
        ...
        <section className="rounded-2xl border border-red-700/55 bg-neutral-950 px-4 py-3 shadow-[0_0_26px_rgba(127,29,29,0.18)]">
          <div className="flex items-center justify-between gap-4">
            <div>
              <h1 className="text-xs font-black tracking-[0.14em] text-white uppercase">
                Mi ruta optimizada
              </h1>
              <p className="mt-1 text-[0.68rem] text-neutral-400">
            ...
            <button
              type="button"
              className="flex min-h-9 items-center gap-2 rounded-md border border-red-600/60 px-3 text-[0.62rem] font-bold text-red-400 transition hover:border-red-500 hover:bg-red-950/40 hover:text-red-300 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-500"
            >
              Ver ruta
