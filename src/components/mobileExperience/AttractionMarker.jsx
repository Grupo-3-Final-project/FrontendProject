function AttractionMarker({ attraction }) {
  const { name, waitTime, position } = attraction
  ...
  return (
    ...
    >
      ...
      <span className="relative z-20 block h-2 w-2 rounded-full bg-red-600 ring-4 ring-red-600/20 shadow-[0_0_18px_rgba(239,68,68,0.95)]" />
    </article>
  )
}
